...
<head>
    ...
    <link href="/rasdaman/static/wcs-client/assets/components/jquery-ui/themes/smoothness/jquery-ui.min.css"
          rel="stylesheet"/>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default" id="panel1">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in">
                        <form id="serviceIdentification" method="post" action="?updateIdentification=true"
                              onsubmit="return validateFormIdentification();">
                            ...
                            <table style="width:80%; margin: 20px;">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="serviceTitle" id="serviceTitle"
                                        <%
                                                       ...
                                                       %>
                                               style="width: 475px;" placeholder="Service Title"
                                               title="Enter service title" class="required"></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                                <textarea name="abstract" id="abstract" style="margin-left: 0px;"
                                                          rows="10" cols="57"><%
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="serviceTypeVersion" id="serviceTypeVersion"
                                        <%
                                                       ...
                                                       %>
                                               style="width: 475px;" placeholder="Service version (x.x.x)"
                                               title="Enter service type version" class="required"></td>
                                </tr>
                ...
                <form id="service_provider" method="post" action="?updateProvider=true"
                      onsubmit="return validateFormServiceProvider();">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in">
                                <table style="width:80%; margin: 20px;">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="providerName" id="providerName"
                                            <%
                                                           ...
                                                           %>
                                                   style="width: 475px;" placeholder="Provider name"
                                                   title="Enter provider name" class="required"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="providerWebsite" id="providerWebsite"
                                            <%
                                                           ...
                                                           %>
                                                   style="width: 475px;" placeholder="Provider website"
                                                   title="Enter provider website" class="required"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="contactPerson" id="contactPerson"
                                            <%
                                                           ...
                                                           %>
                                                   style="width: 475px;" placeholder="Contact person"
                                                   title="Enter contact person" class="required"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="positionName" id="positionName"
                                            <%
                                                           ...
                                                           %>
                                                   style="width: 475px;" placeholder="Position name"
                                                   title="Enter position name" class="required"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea name="email" id="email" style="margin-left: 0px;" rows="3"
                                                      cols="57"><%
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="hoursOfService"
                                            <%
                                                           ...
                                                           %>
                                                   style="width: 475px;" placeholder="Hours of service"
                                                   title="Enter hours of service" class="required"></td>
                                    </tr>

                                    <!-------- Contact instructions --->
                                    <tr>
                                        <td><label for="name">Contact instructions</label></td>
                                        <td><textarea name="contactInstructions" style="margin-left: 0px;" rows="3"
                                                      cols="57"><%
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea name="cityAddress" id="cityAddress" style="margin-left: 0px;"
                                                      rows="3" cols="57"><%
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea name="administrativeArea" style="margin-left: 0px;" rows="3"
                                                      cols="57"><%
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="postalCode" id="postalCode"
                                            <%
                                                           ...
                                                           %>
                                                   style="width: 475px;" placeholder="Postal Code"
                                                   title="Enter postal code" class="required"></td>
                                    </tr>
