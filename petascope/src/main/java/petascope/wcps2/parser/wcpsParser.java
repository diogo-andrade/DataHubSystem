...
public class wcpsParser extends Parser {
    ...
    public static class ForClauseLabelContext extends ForClauseContext {
        ...
        public List<TerminalNode> IDENTIFIER() {
            return getTokens(wcpsParser.IDENTIFIER);
        }
        ...
        public TerminalNode RIGHT_PARANTHESIS() {
            return getToken(wcpsParser.RIGHT_PARANTHESIS, 0);
        }

        public TerminalNode LEFT_PARANTHESIS() {
            return getToken(wcpsParser.LEFT_PARANTHESIS, 0);
        }
    ...
    public static class CoverageIdExpressionContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_coverageIdExpression;
        }
    ...
    public static class CoverageIdExpressionLabelContext extends CoverageIdExpressionContext {
        public TerminalNode ID() {
            return getToken(wcpsParser.ID, 0);
        }
        ...
        public CoverageIdExpressionLabelContext(CoverageIdExpressionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof wcpsVisitor)
                return ((wcpsVisitor<? extends T>) visitor).visitCoverageIdExpressionLabel(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FieldInterpolationListLabelContext extends FieldInterpolationListContext {
        ...
        public FieldInterpolationListLabelContext(FieldInterpolationListContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof wcpsVisitor)
                return ((wcpsVisitor<? extends T>) visitor).visitFieldInterpolationListLabel(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class CRSIntervalExpressionLabelContext extends IntervalExpressionContext {
        ...
        public TerminalNode IMGCRSDOMAIN() {
            return getToken(wcpsParser.IMGCRSDOMAIN, 0);
        }

        public CRSIntervalExpressionLabelContext(IntervalExpressionContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof wcpsVisitor)
                return ((wcpsVisitor<? extends T>) visitor).visitCRSIntervalExpressionLabel(this);
            else return visitor.visitChildren(this);
        }
    }
