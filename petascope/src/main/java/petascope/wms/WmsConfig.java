...
public class WmsConfig {
    ...
    @Deprecated
    public static final String PARAMETER_SUPPORT_XML_EXCEPTION = CONFIG_PARAMETER_WMS_PREFIX + "SupportXMLException";
    @Deprecated
    public static final String PARAMETER_SUPPORT_INIMAGE_EXCEPTION = CONFIG_PARAMETER_WMS_PREFIX + "SupportINIMAGEException";
    @Deprecated
    public static final String PARAMETER_SUPPORT_BLANK_EXCEPTION = CONFIG_PARAMETER_WMS_PREFIX + "SupportBLANKException";
    ...
    protected LayerContainer buildWMSLayerMapAndLayers(String layerParam) throws WMSException {
        ...
        while (stLayer.hasMoreElements()) { //go through the layers
    ...
    protected WmsCapabilities.WmsLayer createLayer(String layer) throws WMSException {
        ...
        while (stSLayer.hasMoreElements()) { // go through the persistent layers
        ...
        while (stStyles.hasMoreElements()) {   //get all styles
