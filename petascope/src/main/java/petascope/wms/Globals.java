...
public interface Globals {
    ...
    @Deprecated
    public static final int ERR_UnsupportedExceptionXml = 201;    // obsolete
    @Deprecated
    public static final int ERR_UnsupportedExceptionBlank = 202;    // obsolete
    @Deprecated
    public static final int ERR_UnsupportedExceptionInimage = 203;    // obsolete
